...
We are legally bound to respond to the client within 3 hours of receiving their email.
...
promising a resolution timeframe. It is mainly a notification of receipt.
The body of the message can be as simple as "Thank you, we will look into
